...
- [supercli](https://github.com/javimosch/supercli) - Universal CLI router with 7,003 plugins. One command pattern for every tool, JSON-by-default output, agent-native discovery.
